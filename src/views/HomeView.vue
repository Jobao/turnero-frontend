<template>
  <div class="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
    ...
    <div class="flex mt-5 flex-col">
      <RouterLink v-for="prof in fakeDataProfesional" :to="URLS.PROFESSIONAL + '/'+ prof.professionalID" class="flex-1 rounded-full bg-blue-600 dark:bg-blue-800 text-white dark:text-white antialiased font-bold hover:bg-blue-800 dark:hover:bg-blue-900 px-4 py-2 m-2">{{ prof.name }}</RouterLink>
    </div>
  </div>
  <div></div>
</template>
