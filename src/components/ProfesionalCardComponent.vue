  ...
  <div class="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
    <div class="border-b px-4 pb-6">
      <div class="text-center my-4">
        ...
        <div class="py-2">
          <h3 class="font-bold text-2xl text-gray-800 dark:text-white mb-2">{{ props.profesional.name }}</h3>
          <p class="mb-2">{{ props.profesional.description }}</p>
          <div v-if="props.profesional.mapURL !== '' && props.profesional.mapURL !== undefined" class="inline-flex text-gray-700 dark:text-gray-300 items-center">
      ...
      <div class="flex gap-2 px-2">
        ...
        <WhatsappButtonComponent :phone="props.profesional.phone ? props.profesional.phone : ''"></WhatsappButtonComponent>
      </div>
    </div>
  </div>
</template>
